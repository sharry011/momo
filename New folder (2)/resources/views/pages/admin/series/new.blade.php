...
@section('title', 'مسلسل جديد')

@section('content')
    <form class="row p-0 m-0 my-4" id="new_post_form"
          action="{{url(route('admin.series.new.post'))}}" method="post"  enctype="multipart/form-data">
        @csrf
            ...
            <div class="cont">
                ...
                <div class="details">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control mb-3" type="text" placeholder="العنوان" value=""
                               name="title"
                               required/>
                    </div>
            ...
            <div class="cont">
                ...
                <div class="details">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" maxlength="5" value=""
                                   name="rating"/>
                        </div>
                    </div>
            ...
            <div class="cont">
                ...
                <div class="details">
                    ...
                    <div class="show-card" id="img_preview"
                         style="background-image: url('/photos/imgs/placeholder.webp'); --br: 0"></div>
                </div>
            </div>
            ...
            <div class="cont">
                ...
                <div class="details">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="number" placeholder="السنة" value=""
                               name="year"/>
                    </div>
                    <div class="mb-3">
