...
@section('title', 'تعديل معلومات المسلسل ')

@section('content')
    <form class="row p-0 m-0 my-4" id="new_post_form" enctype="multipart/form-data"
          action="{{url(route('admin.series.update.post', ['id' => $post->id]))}}" method="post"  enctype="multipart/form-data">
        @csrf

        <div class="first_title col-12">
            <h3>تعديل معلومات المسلسل</h3>
        </div>
