...
@section('content')
    <form class="row p-0 m-0 my-4" id="new_post_form"
          action="{{
    route('admin.articles.new.post')}}" method="post" enctype="multipart/form-data">
